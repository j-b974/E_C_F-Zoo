<div  class="mb-3 m-auto"style="width: 48rem;">
    ...
    <div class ="d-flex  bg-primary text-white overflow-auto" >
        <?php require dirname(__DIR__,3).DIRECTORY_SEPARATOR.'template'.DIRECTORY_SEPARATOR.'Cards'.DIRECTORY_SEPARATOR.'CardCompteRenduEmployeView.php'; ?>
    </div>
</div>
